...
Cada película se muestra en una card con:
...
Diseño responsive, funciona bien en dispositivos móviles, tabletas y escritorio.

Botón de carga que actualiza las películas en pantalla.

Basado en HTML, CSS, JavaScript y Bootstrap.
...
JavaScript (Fetch API) – Consumo de la API y renderizado dinámico.
